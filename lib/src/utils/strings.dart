...
Tunashirikishana taarifa mbali mbali kuhusiana na magari yetu \n
...
const signInWithGoogleText =
    'Ingia kwa kutumia akaunti ya Google'; //'Sign in with Google';
...
const errorMessage =
    'Samahani, kuna hitilafu imetokea'; // 'Something went wrong';
const logoutText = 'Ondoka'; // 'Logout';

const devByText =
    'Imetengenezwa na NyayoZangu Labs'; // 'Developed by NyayoZangu Labs';
